...
#define Pump  16 // Light  GPIO16(D0)
...
void loop() {
    server.handleClient();
      ...
      else if (command == "W")digitalWrite(Pump, HIGH); // light is on
      else if (command == "w")digitalWrite(Pump, LOW);  // light is off
